    ...
    return (
        <>
            <div className="container-fluid">
                ...
                <h1 align='center' className="m-5">{t('Iam')} Web
                ...
                <div style={{ height: '100%' }}>
                    <h3 align="center"><u>{t('MY KEY SKILLS')}</u></h3>
                    <div className="m-3 row row-cols-1 row-cols-md-3 g-3 text-bg-white p-5" align="center" >
                        <div className="col g-1 ">
                            ...
                            k5PMnkAA3NQAAADJgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA//Z" height={'250px'} width={''} className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">{t('JavaScript')}</h5>
                        ...
                        <div className="col g-1" >
                            <div className="card g-1">
                                <img src="https://th.bing.com/th/id/OIP.5PxGgx_aOWpTkul_D3nnbwAAAA?w=335&h=185&c=7&r=0&o=5&pid=1.7" height={'251px'} className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">React{t('.JS')}</h5>
                        ...
                        <div className="col g-1" >
                            <div className="card g-1" >
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{t('HTML5')}</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col g-1">
                            ...
                            AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAYAAGQABgAAZAAGAABkAAYAAAADIAAwAAMgADAAAyAAMAADIAAAAD//2Q==" height={'250px'} width={''} className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">{t('CSS3')}</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col g-1">
                            <div className="card g-1 ">
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{t('BOOTSTRAP')}</h5>
                                </div>
                            </div>
                        </div>
                        <div className="col g-1">
                            <div className="card g-1">
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{t('j')}QUERY</h5>
                                </div>
                            </div>
                        </div>
                    </div>
